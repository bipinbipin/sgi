...
main ( int argc, char **argv )
{
    ...
    VLNode src, drn;
    VLBuffer buf;
    int transferSize;	/* VL Frame Size */
    VLControlValue val;
    
    MVframe frameNum;	/* The frame number we're doing */
    int	xOutSize, yOutSize, xInSize, yInSize;
    ...
    orientation = (DMorientation)
		dmParamsGetEnum( sourceParams, DM_IMAGE_ORIENTATION );
    mvFrames = dmParamsGetInt ( sourceParams, MV_TRACK_LENGTH );
    mvInter = (DMinterlacing)
		dmParamsGetEnum ( sourceParams, DM_IMAGE_INTERLACING );
