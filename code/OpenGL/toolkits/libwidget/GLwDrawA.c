 ...
 */
/* begin sneaky bit...if we are using the Motif 2.1 headers then change the 
 * names of the structures --- offer */
#if XmVERSION > 1
#define GLwDrawingAreaWidget		GLwM21DrawingAreaWidget
#define GLwDrawingAreaClassRec		GLwM21DrawingAreaClassRec
#define glwDrawingAreaClassRec		glwM21DrawingAreaClassRec
#define glwDrawingAreaWidgetClass	glwM21DrawingAreaWidgetClass
#define GLwDrawingAreaRec		GLwM21DrawingAreaRec

#define GLwCreateMDrawingArea		GLwCreateM21DrawingArea
#define GLwMDrawingAreaWidgetClass GLwM21DrawingAreaWidgetClass
#define GLwMDrawingAreaWidget GLwM21DrawingAreaWidget
/* These functions have been moved to the internal API for Motif 2.1 */
extern void _XmForegroundColorDefault(Widget, int, XrmValue *);
extern void _XmHighlightColorDefault(Widget, int, XrmValue *);
extern void _XmBackgroundColorDefault(Widget, int, XrmValue *);
extern void _XmPrimitiveHighlightPixmapDefault(Widget, int, XrmValue *);
#else
