...
ExampleAsmCodec	ÄÄ	 makefile ExampleCodecAsm.r {warholSources}Interface:"Image Codec.r" "{warholObjects}"registerthings
	Echo   "# `date -s -t` -- Rezzing ExampleCodecAsm"
	Rez {ROptions} -o ExampleCodecAsm -c 'appl' -t 'thng' ExampleCodecAsm.r


	
ExampleAsmCodec 	ÄÄ	"{warholObjects}"ExampleCodecAsm.c.o ¶
...
"{warholObjects}"ExampleCodecAsm.c.o Ä 'Makefile' ExampleCodec.c {imagecomp} {codecguts}
	Echo   "# `date -s -t` -- Compiling ExampleCodecAsm"
	 C -o "{warholObjects}"ExampleCodecAsm.c.o -D HAS_ASM -b2 {COptions} ExampleCodec.c 

"{warholObjects}"ExampleCodec.a.o Ä 'Makefile' ExampleCodec.a {imagecomp} {codecguts}
